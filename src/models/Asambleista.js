...
class Asambleista {
    ...
    static async hojaDeVida(cedula, fecha_inicio = null, fecha_fin = null) {
        ...
        return {
            ...
            total_sesiones_convocadas:  Number(primer.total_sesiones_convocadas) || 0,
            total_asistencias:          Number(primer.total_asistencias) || 0,
            porcentaje_asistencia:      Number(primer.porcentaje_asistencia) || 0,
            total_propuestas:           Number(primer.total_propuestas) || 0,
            total_comisiones:           Number(primer.total_comisiones) || 0,
            nombramientos: rows
